...
GUESSED_LETTER_FONT = pygame.font.Font("Monstrous Fish.otf", 50)
AVAILABLE_LETTER_FONT = pygame.font.Font("Monstrous Fish.otf", 25)
...
def play_again():
    ...
    play_again_font = pygame.font.Font("Monstrous Fish.otf", 40)
